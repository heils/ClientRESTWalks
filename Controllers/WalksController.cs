...
namespace Client.Controllers
{
    public class WalksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchQuery)
        {
            ...
            var httpResponseMessage = await client.GetAsync($"https://app-walks-canada-dev-001.azurewebsites.net/api/walks?filterOn=Name&filterQuery={searchQuery}");
        ...
        public async Task<IActionResult> Add(CreateWalkDto walkDto)
        {
            ...
            var httpRequestMessage = new HttpRequestMessage()
            {
                ...
                RequestUri = new Uri("https://app-walks-canada-dev-001.azurewebsites.net/api/walks"),
        ...
        {
            var client = httpClientFactory.CreateClient();
            var httpResponseMessage = await client.GetAsync("https://app-walks-canada-dev-001.azurewebsites.net/api/walks/getoptionslist");
